...
export default function DetailProduct() {
  return (
    ...
    <div className="mt-16">
        <h2 className="text-3xl font-bold mb-8 font-[Plus_Jakarta_Sans] font-medium text-[48px] leading-[100%] tracking-[0%] text-[#0B0909]">Recommendation <span className="text-[#8E6447]">For You</span></h2>
