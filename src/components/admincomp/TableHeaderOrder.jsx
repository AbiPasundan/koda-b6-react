...
export default function TableHeaderOrder() {
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex flex-col">
                            ...
                            <div className="relative">
                                ...
                                <select name="cars" id="car-select" className="pl-4 pr-16 py-2 border border-gray-300 rounded-md w-64 focus:outline-none focus:ring-1 focus:ring-orange-500">
                        ...
                        <div className="flex flex-col">
                            <label className="text-sm text-gray-500 mb-1">Search Order</label>
                            <div className="relative">
                                <input type="text" placeholder="Enter User Name" className="pl-4 pr-10 py-2 border border-gray-300 rounded-md w-64 focus:outline-none focus:ring-1 focus:ring-orange-500" />
